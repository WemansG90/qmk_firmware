...
*/
  ...
  [_DEFAULT] = LAYOUT_60_ansi( /* HHKB QWERTY w/full bottom row */
      ...
      MO(_FN1),KC_LGUI, KC_LALT,                  KC_SPC,                   KC_RALT, KC_LGUI, KC_APP,  KC_RCTL \
      ),
  [_FN1] = LAYOUT_60_ansi( /* Layer 1 */
      xxxxxx,  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS, \
      ...
      xxxxxx,           KC_MPRV, KC_MPLY, KC_MNXT,KC_MSTP, xxxxxx,  KC_END, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, xxxxxx, \
